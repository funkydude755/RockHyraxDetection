...
# ==============================================================================
import sys
sys.path.append('/home/ok/models_master/models/research/slim/')
...
def main(_):
  ...
  with tf.gfile.GFile("/home/ok/Downloads/raccoon_dataset-master/training/faster_rcnn_inception_v2_pets.config", 'r') as f:
